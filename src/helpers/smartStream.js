...
// this class is not implemented by me
// resource - https://github.com/about14sheep/awsstreaming
export class SmartStream extends Readable {
	...
	_s3DataRange = 10 ** 6; // Amount of bytes to grab (I have jacked this up HD video files)
	_maxContentLength; // Total number of bites in the file
	_s3 = AWS.S3; // AWS.S3 instance
